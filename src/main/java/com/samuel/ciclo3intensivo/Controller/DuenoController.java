...
public class DuenoController {
    ...
    public String irPaginaListadoRazas(Map<String, Object> model) {
        model.put("listaDuenos", duenoService.listar());
        return "views/listDueno";
    }
            ...
            throws ParseException
    {
        if (binRes.hasErrors())
            ...
            boolean flag = duenoService.registar(objDueno);
    ...
    public String modificar(@PathVariable int id, Model model, RedirectAttributes objRedir)
            throws ParseException
    {
        Optional<Dueno> objDueno = duenoService.ListarById(id);
        if (objDueno == null) {
